CREATE OR REPLACE VIEW MODELS.KERING_GLOBE.CRT_KER_01_INBOUND (
...
RANGE_PARAMS AS (
  SELECT
    ...
    TO_TIMESTAMP_NTZ('2025-08-31 23:59:59') AS END_TS  -- END is exclusive if you prefer, set 23:59:59.999
),
